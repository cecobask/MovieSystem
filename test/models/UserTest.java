...
public class UserTest {
	...
	User tsvetoslav = new User("Tsvetoslav", "Dimov", 21, "male", "customer assistant", "x91 v5w6", "1234", "admin");
	...
	public void testToString(){
		assertEquals("User{" + tsvetoslav.userId + ", Tsvetoslav, Dimov, 21, male, customer assistant, x91 v5w6, 1234, admin}", tsvetoslav.toString());
	}
	
	@Test
	public void testEquals(){
		User tsssvetoslav = new User("Tsvetoslav", "Dimov", 21, "male", "customer assistant", "x91 v5w6", "1234", "admin");
